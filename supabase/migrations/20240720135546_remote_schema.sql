...
CREATE POLICY "Order Items policy" ON "public"."order_items" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Order Policy" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);
